...
- val 0.7356, Public 0.710

ver3
- 単語の数,単語の平均長さ, 文の数(ピリオドの個数), 一文の平均の長さ, アルファベットの数
- val 0.7354, Public 0.703

ver4
- 単語の数,単語の平均長さ, 文の数(ピリオドの個数), 一文の平均の長さ, 大文字の数
- val 0.7303, Public 0.703

ver5
- 単語の数,単語の平均長さ, 文の数(ピリオドの個数), 一文の平均の長さ, 大文字の数, 名詞の数
- val 0.7317, Public　0.705

ver6
- 単語の数,単語の平均長さ, 文の数(ピリオドの個数), 一文の平均の長さ, 大文字の数, 名詞の数, 名詞の平均の長さ
- val 0.7295, Public 0.703

ver7
- 単語の数,単語の平均長さ, 文の数(ピリオドの個数), 一文の平均の長さ, 大文字の数, 名詞の平均の長さ
- val 0.7281, Public 0.702
